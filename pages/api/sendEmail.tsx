...
To: <${email}>
Subject: Historial Académico y Exámenes extraordinarios Mayo-Agosto 2023

Estimad@ ${name}:

Por este medio le hacemos llegar su historial académico correspondiente al cuatrimestre que finaliza.

En caso de presentar algún extraordinario deberá acudir al área de Subdirección Académica donde brindaremos su formato de pago que posteriormente se entregará junto con el pago correspondiente en el área de caja, siendo el único día para realizar dicho trámite el día viernes 18 del presente mes.
El horario de atención en caja es de 9:00 hrs a 14:00 hrs y de 15:00 hrs. a 16:30 hrs. Con un costo de $246 c/u. Cabe resaltar que el pago de extraordinario será únicamente de manera presencial.
...
${url}`
            ...
            return res.status(200).json({status: response.data.labelIds, email: email})
        }
    } catch(e) {
